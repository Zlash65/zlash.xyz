  ...
  const experiences = [
    {
      ...
      achievements: [
        ...
        "Implemented a read replica architecture and updated the application to route read and write traffic separately, improving app performance and stabilizing database resource usage.",
        "Led a security hardening effort toward compliance readiness by tightening secrets management, enforcing least-privilege access controls, enabling comprehensive audit logging and alerts, and adding secret scanning to version control.",
        "Built and deployed an analytics microservice using serverless functions and managed database service, provisioned via IaC with automated CI/CD pipelines.",
        "Forked an open-source integration server for internal use, containerized and deployed it behind a load balancer using IaC. Connected it to AI tools for direct CRM data access.",
        "Deployed self-hosted vector database on container infrastructure with persistent storage, all infrastructure managed as code.",
        "Deployed data application microservice and self-hosted data orchestration platform on container infrastructure with object storage, persistent volumes, and relational database backend, adding authentication layers for secure access.",
        "Enhanced database IaC modules to support separate instance classes for read and write nodes, multiple database engines, and optional geographic extensions.",
        "Developed a full-stack in-house CRM platform using an application framework, provisioned entirely through IaC. The CRM synced data from the product database and aggregated information from multiple sources including email, meeting notes, calls, video conferences, and calendars—all enhanced with AI-powered insights.",
        "Integrated product analytics and session replay capabilities into the CRM, allowing seamless observation of user journeys across different customer segments.",
        "Built a voice note-taking feature that transcribes audio using speech-to-text services and enhances transcripts with AI for better context and clarity.",
        "Created numerous workflow automations using multiple automation platforms, including email summarization, task management integration, deployment failure alerts, intelligent email responses, and video conference recording processing with AI-enhanced transcripts.",
      ],
    },
    {
      ...
      achievements: [
        "Led infrastructure automation efforts by creating and maintaining modular IaC modules for container services, container registry, managed databases, networking, caching layers, etc., published to a private registry to streamline deployment across environments.",
        "Migrated frontend hosting from third-party platform to cloud-native static hosting with CDN, reducing latency and significantly cutting hosting costs.",
        "Architected and deployed microservices on container orchestration platform with fully automated CI/CD pipelines, improving deployment speed and reliability.",
        "Refactored infrastructure into clean, reusable Infrastructure as Code modules, boosting consistency across production and development environments.",
        "Developed multiple backend APIs for analytics, third-party data ingestion, and business intelligence.",
        "Wrote data processing scripts for web scraping, data enrichment, and pre-population workflows using AI-driven enrichment tools and language models, supporting rapid market expansion.",
        "Integrated monitoring service for full-stack observability and set up custom BI dashboards to track KPIs and surface operational insights. Collaborated cross-functionally to translate business needs into scalable, automated technical solutions.",
        "Created IaC modules for monitoring alerts, SLOs, and synthetic health checks to enable consistent observability across services.",
